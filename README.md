...
The current Freesurfer version is based on: `freesurfer-linux-centos8_x86_64-7.1.1.tar.gz`

The output of the pipeline consists of the SUBJECTS_DIR created during the analysis.
